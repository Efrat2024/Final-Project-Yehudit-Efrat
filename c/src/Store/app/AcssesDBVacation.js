...
<p>rrrrrrrrrrrrrrrrrrrrrr</p>
            <div className="col-12" key={vacation?._id}>
                <div className={classNames('flex flex-column xl:flex-row xl:align-items-start p-4 gap-4', { 'border-top-1 surface-border': index !== 0 })}>
                    ...
                    <img className="w-9 sm:w-16rem xl:w-10rem shadow-2 block xl:block mx-auto border-round" src={`https://server-tam.onrender.com/${vacation?.image}`} alt={vacation?.name} />
            ...
            <div className="col-12 sm:col-6 lg:col-12 xl:col-4 p-2" key={vacation?._id}>
                <div className="p-4 border-1 surface-border surface-card border-round">
                    ...
                    <div className="flex flex-column align-items-center gap-3 py-5">
                        <img className="w-9 shadow-2 border-round" src={`https://server-tam.onrender.com/${vacation?.image}`} alt={vacation?.name} />
                        <div className="text-2xl font-bold text-900">{vacation?.name}</div>
                        <div className="text-xl font-bold ">{vacation?.description}</div>
                    </div>
