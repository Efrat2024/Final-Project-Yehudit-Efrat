...
console.log("im in func if null");
  ...
  const images = [
    ...
    {
      url: data && data[0]?.images[0] ? `https://server-tam.onrender.com/uploads/${data[0].images[0].split("\\")[2]}` : '../../../a/logo.png',
    ...
    {
      url: data && data[1]?.images[1] ? `https://server-tam.onrender.com/uploads/${data[1].images[0].split("\\")[2]}` : 'https://images.unsplash.com/photo-1531299204812-e6d44d9a185c?auto=format&fit=crop&w=400',
    ...
    {
      url: data && data[2]?.images[0] ? `https://server-tam.onrender.com/uploads/${data[2].images[0].split("\\")[2]}`: 'https://images.unsplash.com/photo-1476480862126-209bfaa8edc8?auto=format&fit=crop&w=400',
      title: data && data[2]?.images[0] ? data[2].name :'Hiking',
      width: '40%',
      id:  data && data[2]?.images[0] ? data[2]._id : "nullo"
    },
    {
      url: data && data[3]?.images[0] ? `https://server-tam.onrender.com/uploads/${data[3].images[0].split("\\")[2]}`: 'https://images.unsplash.com/photo-1453747063559-36695c8771bd?auto=format&fit=crop&w=400',
      title: data && data[3]?.images[0] ? data[2].name:'Tour',
      width: '38%',
      id:  data && data[3]?.images[0] ? data[3]._id : "nullo"
    },
    {
      url: data && data[4]?.images[0] ? `https://server-tam.onrender.com/uploads/${data[4].images[0].split("\\")[2]}`:'https://images.unsplash.com/photo-1523309996740-d5315f9cc28b?auto=format&fit=crop&w=400',
      title: data && data[4]?.images[0] ? data[4].name:'Gastronomy',
      width: '38%',
      id:  data && data[4]?.images[0] ? data[4]._id : "nullo"
    },
    {
      url: data && data[5]?.images[0] ? `https://server-tam.onrender.com/uploads/${data[5].images[0].split("\\")[2]}`:'https://images.unsplash.com/photo-1534452203293-494d7ddbf7e0?auto=format&fit=crop&w=400',
      title: data && data[5]?.images[0] ? data[5].name:'Shopping',
      width: '24%',
      id:  data && data[5]?.images[0] ? data[5]._id :"nullo"
    },
    {
      url:  data && data[6]?.images[0] ? `https://server-tam.onrender.com/uploads/${data[6].images[0].split("\\")[2]}`:'https://images.unsplash.com/photo-1506941433945-99a2aa4bd50a?auto=format&fit=crop&w=400',
      title: data && data[6]?.images[0] ? data[6].name:'Walking',
      width: '40%',
      id:  data && data[6]?.images[0] ? data[6]._id :"nullo"
    },
    {
      url: data && data[7]?.images[0] ? `https://server-tam.onrender.com/uploads/${data[7].images[0].split("\\")[2]}`:'https://images.unsplash.com/photo-1533727937480-da3a97967e95?auto=format&fit=crop&w=400',
